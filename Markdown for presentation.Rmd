...
The first step is to calculate the absolute value of the fold change, to find the difference in expression of every single gene between treated and untreated cell lines. This way we can detect the biggest changes, regardles off if the expession of the genes was up- or down-regulated.
