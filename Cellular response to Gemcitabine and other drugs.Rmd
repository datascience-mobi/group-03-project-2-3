...
plot(pca_FC$rotation[, 1], pca_FC$rotation[, 2], pch = 19, xlab = "PC 1",ylab = "PC 2", col=drug_as_factor, main = "PCA of the fold change ")
legend("bottomright", levels(drug_as_factor), xpd = TRUE, pch=19, col = levels)
```
