...
To answer the question wheter MSI status affects the fold change after gemcitibine treatment, we investigate the fold change of our 15 biomarkers for gemcitibine. But at first of all, we want to see, which effect the MSI status has on the geneexpression, so we pick out 2 of the important genes for MSI Instability (MLH1 and MSH6) which both belong to the MMR system, the mismatch repair system. In MSI-H cancers they should be downregulated, so that the repair system does not work anymore.
