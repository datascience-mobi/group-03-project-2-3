...
#Plotting mutations
Counting mutations, MSI relation?
...
```
It is obvious that MSI status affects the number of mutations, due to mutations in the repair system
...
(Still unsure of how to proceed with the linear regression)
