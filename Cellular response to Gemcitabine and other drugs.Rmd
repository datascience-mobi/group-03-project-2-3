...
Loading the libraries of the packages required
...
A scree plot shows, how much variance a Principal Component explains. As you can see, there is a "knick" in the curve at PC 2, so we stop plotting any PCs.
