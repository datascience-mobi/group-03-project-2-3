...
pheatmap(HighGI50,color = colorRampPalette(c("blue","white","purple","firebrick3","red","orange"))(10), breaks = c(0,6,19,113,2229), main= "Celllines with high GI50 values")

quantile(LowGI50)

pheatmap(LowGI50,color = colorRampPalette(c("blue","white","purple","firebrick3","red","orange"))(10), breaks = c(0,8,22,172,6716), main = "Celllines with low GI50 values")
...
barplot(correlations.cn.genexp, ylim = c(-1,1), las = 2, cex.names = 0.8, col = "blue", 
...
abline(lm(DS_Gemcitabine~ATF3, data = as.data.frame(genexp.drugsens)), col = "blue")
```
...
abline(lm(DS_Gemcitabine~ATF3, data = as.data.frame(copynum.drugsens)), col = "blue")
```
