...
The drug sensitivity matrix contains the GI50 values of several celllines when exposed to different
...
barplot(all.r.squared, ylim = c(0,1), ylab = "R-squared value", 
        main = "Linear regressions using gene expression", cex.names = 0.7, las = 2)
