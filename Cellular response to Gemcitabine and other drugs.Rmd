...
## Drug sensitivity and cell line - FORMULATE AS QUESTION
...
In order to investigate the difference in gemcitabine sensitivity for different cell lines a mean graph plot is plottet. 
...
A more effective way to Other possibilities to explain a celllines sensitivity to gemcitabine are 
