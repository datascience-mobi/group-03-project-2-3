...
plot(pca_FC$rotation[, 1], pca_FC$rotation[, 2], pch = 19, xlab = "PC 1",ylab = "PC 2", col=drug_as_factor, main = "PC 1&2 of the fold change ")
legend("bottomright", levels(drug_as_factor), xpd = TRUE, pch=19, col = levels)

plot(pca_FC$rotation[, 3], pca_FC$rotation[, 4], pch = 19, xlab = "PC 3",ylab = "PC 4", col=drug_as_factor, main = "PC 3&4 of the fold change ")
legend("bottomright", levels(drug_as_factor), xpd = TRUE, pch=19, col = levels)
```
