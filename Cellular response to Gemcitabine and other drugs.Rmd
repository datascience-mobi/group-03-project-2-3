...
#screen plot to show how much variance the PCs explain
plot(pca_FC, type = "l", main = "PCAs of the fold change")
```

A scree plot shows, how much variance a Principal Component explains. As you can see, PC 3 and 4 still explain the data, we also plot them. 
...
par(mfrow=c(1,2))
qqPlot(Treated_Gemcitabine_Normalised, main="Q-Q Plot Normalised treated data", ylab= "Normalised treated Gemcitabine data")
qqPlot(Untreated_Gemcitabine_Normalised, main="Q-Q Plot Normalised untreated data", ylab= "Normalised untreated Gemcitabine data"  )
```
...
# Microsatellite instability - Does gemcitabine has an effect on the geneexpression
