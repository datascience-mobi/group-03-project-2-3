...
of the boxplots are not levelled. This indicates the lack of normalisation. Thus, the data is normalised and a boxplot is generated again.
...
The levelled mean indicates normalisation.
...
pheatmap(cbind(geneexpression_MSI_related_untreated_MSIH, geneexpression_MSI_related_untreated_MSIL), cluster_rows = FALSE, cluster_cols = FALSE, gaps_col = 8, cellheight = 20, name = "MLH1 and MSH6", fontsize_row = 8, fontsize_col = 6)
```
...
frameshifthigh = c()
for (i in (celllineshigh) ) {
     o = print(sum(mutations[
    which(mutations$Tumor_Sample_Barcode == i),"Variant_Classification"]
     == "Frame_Shift_Del"))
     frameshifthigh = c(frameshifthigh, o}
